  ...
  return (
    <div className='flex items-center justify-between  p-4 bg-[var(--a)] '>
        ...
        <div className="icons flex items-center justify-end w-full gap-4">
           <Link href="/messages" className=" bg-white/10 p-2 rounded-full hover:bg-[var(--p)] hover:scale-105 active:scale-98 transition duration-300 ease-in-out">
                <Image src="/message.png" alt="Message" width={25} height={25} className="" />
            </Link>
            <Link href="/announcements" className=" bg-white/10 p-2 rounded-full relative  hover:bg-[var(--p)] hover:scale-105 active:scale-98 transition duration-300 ease-in-out">
            ...
            <Link href="/profile" className="flex items-center justify-center gap-2 bg-white/10 p-2 rounded-full hover:bg-[var(--p)] hover:scale-102  transition duration-300 ease-in-out">
