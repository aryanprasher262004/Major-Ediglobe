...
const renderRows=(item : Student) => ( // this is also a prop that will be passes to the parent component i.e. Tables.tsx  HERE instead of using {} we are using ()to return the data to parent
  ...
  return (
    <div className='bg-[var(--bg)] p-4 rounded-md flex-1 m-3 '>
      ...
      <div className="flex items-center justify-between ">
        <h1 className="hidden md:block text-2xl font-semibold"> All Students</h1>
      ...
      {/* table */}
      <div className="">
        <Tables columns={columns} renderRows={renderRows}  data={studentsData} />
      </div>
